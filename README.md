...
- Full Inventory control (add, edit, delete stock)
- Promotes a team member to Manager
- Grants/revokes Inventory Edit Access per member

**Manager**
- Can edit Inventory (add/adjust stock)
- Access stays active until the Owner revokes it

**Team Member**
- Records sales for their assigned business
...
4. They redeem it on their own account and get linked as Team Member
...
4. **Add item name:** Label your products for easy tracking
5. **Add item add-ons:** Attach optional extras to specific items
6. **Set your price:** Define pricing so the app calculates sales accurately
7. **Set your starting stock:** Track inventory per item/variant from day one
8. **View total sales:** See accurate, up-to-date sales figures at a glance, tagged by payment method
9. **Add home screen widgets:** Monitor real-time sales across all your businesses without opening the app
10. **Add your team** *(optional):* Generate an invite code and bring in staff to record sales for you, in real time

## Why Capoink
Most sales tracking apps lock core features behind recurring subscriptions. Capoink gives small enterprise owners full access to track and analyze sales, no matter how many businesses they run, how far back their data goes, or how many people help run it.
